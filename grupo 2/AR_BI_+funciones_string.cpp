...
{
    menu();
    cout << "EL ALGORITMO SOBRE LAS OPERACIONES DE ARBOLES BINARIOS HA TERMINADO.";
}
void menu() {
    int dato, opcion, numero, contador= 0;
    string respuesta = "si";
    do {
        cout << "\t===============MENU==================" << endl;
        ...
        cout << "9.Presentacion de los recorridos"<<endl;
        ...
        case 3:
            ...
            break;
        case 4:
            cout << "\nDigite el numero que desea eliminar:"<<endl;
            cin >> dato;
            eliminar(arbol, dato);
            cout << "\n";
            respuesta = salida();
        ...
        case 5:
            cout << "\nDigite el numero que desea buscar:"<<endl;
            cin >> dato;
            if(busqueda(arbol, dato)==true)
            {
            	cout<<"\n El numero "<<dato<<" ha sido encontrado "<<endl;
			}
			else
			{
...
string salida(){
    string respuesta = "si";
    cout << "\nDESEA CONTINUAR CON LA PRESENTACION DEL ALGORITMO SOBRE LAS OPERACIONES DE ARBOLES BINARIOS: SI/NO? ";
    cin.ignore();
