...
main() {
        ...
        int clave,n,opcion;
        cout<<"\n--------------------------------------------------------"<<endl;
        cout<<"\tAlgoritmo operaciones del Arbol B "<<endl;
        ...
        cout<<"--------------------------------------------------------"<<endl;
                ...
                case 1:
                		cout<<"\n---------------------------------------------"<<endl;
                        cout<<("Ingrese un elemento para el arbol B: ");
                    	cin>>clave; eatline();
                        Insertar(clave);                        
                        system("pause");
                        system("cls");
                ...
                case 2:
                		cout<<"\n---------------------------------------------"<<endl;
                        cout<<("Ingrese el elemento a borrar del arbol B: ");
                        cin>>clave; eatline();
                        Borrar(clave);
                        system("pause");
                        system("cls");
                ...
                case 3:
                		cout<<"\n---------------------------------------------"<<endl;
                        cout<<("Ingrese el elemento a buscar del arbol B: ");
                        cin>>clave; eatline();
                        Busqueda(clave);
                        system("pause");
                        system("cls");
        ...
        cout<<"Desea continuar con la presentacion del algoritmo de operaciones del arbol B [S/N]: ";
        cin>>opc;
    	}while(opc!='N');	
    	cout<<" El algoritmo de operaciones del arbol B ha finalizado "<<endl;
        return 0;
