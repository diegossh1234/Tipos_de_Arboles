...
Arbol crearNodo(int numero_ingresado)
{
...
void insertar(Arbol &arbol, int numero_ingresado)
{
     if(arbol==NULL)
     {
...
bool busquedaRec(Arbol arbol, int dato)
{
     int r=0;   
...
void elimina(Arbol &arbol, int numero_ingresado)
{
...
void menu()
{
     system("cls");
		...
		cout<<"4. Recorridos en fundidad(Pre, in, post - orden)"<<endl;
...
{
    Arbol arbol = NULL;
    int numero_ingresado,numero_elementos;
    int op, op2;
    string op3;
